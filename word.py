...
rectKernal=cv2.getStructuringElement(cv2.MORPH_RECT,(13,5))
sqKernal=cv2.getStructuringElement(cv2.MORPH_RECT,(21,21))
...
for imagepath in paths.list_images(args['image']):
	...
	blackhat=cv2.morphologyEx(gray,cv2.MORPH_BLACKHAT,rectKernal)
